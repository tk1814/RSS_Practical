...
pybulletConfigs = {
    ...
    "floor": True,
    "cameraSettings": (1.37, 90.0, -52.8, (0.07, 0.01, 0.76))
}
robotConfigs = {
...
task2_targetPosition = np.deg2rad(-45)
...
pltTime, pltTarget, pltTorque, pltTorqueTime, pltPosition, pltVelocity = \
    sim.moveJointToy(task2_jointName, task2_targetPosition, task2_targetVelocity, verbose)
